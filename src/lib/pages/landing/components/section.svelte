...
<div class="section relative mb-[20vh] flex h-fit min-h-screen w-full flex-col justify-start gap-2 px-5 sm:px-10 md:mb-0 lg:h-screen lg:flex-row lg:items-center lg:justify-between" id="section-{id}">
